...
| Create a file: | echo > index.html | touch index.html |
| Create a directory | mkdir nameOfFolder | mkdir nameOfFolder|
| List current directory | cd | pwd |
...
>>>>>>> 061eaf23ec5f1b87ab3eae86f33a39c55aae90c1
